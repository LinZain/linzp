...
public class ActivityInfoServiceImpl implements ActivityInfoService {
	...
	public List<ActivityRole> getActListByPage(String fromApp, String count, int page, int rows) {
		Map<String, Object> params = new HashMap<String, Object>();
		String hql = "from ActivityRole where forApp = :fromApp and act_status = 0 order by act_time desc";
		params.put("fromApp", fromApp);
	...
	public Long countActListByPage(String fromApp) {
		Map<String, Object> params = new HashMap<String, Object>();
		String hql = "select count(*) from ActivityRole where forApp = :fromApp and act_status = 0 order by act_time desc";
		params.put("fromApp", fromApp);
