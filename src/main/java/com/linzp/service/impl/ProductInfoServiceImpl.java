...
public class ProductInfoServiceImpl implements ProductInfoService {
    ...
    public List<Product> getListByGroupId(String groupId, String pdtTitle, String pdtBrand, String pdtCategory) {
        Map<String, Object> params = new HashMap<String, Object>();
        String hql = "select * from tb_product where pdt_id in (select pdt_id from tb_groupNumber where group_id in (:groupId)) ";
        ...
        return (List<Product>) execOrderDAO.findEntityBySql(hql, params, Product.class);
    }

    public List<Product> getListByGroupIdByPage(String groupId, String pdtTitle, String pdtBrand, String pdtCategory, int page, int rows) {
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public BigInteger countListByGroupId(String groupId, String pdtTitle, String pdtBrand, String pdtCategory) {
        Map<String, Object> params = new HashMap<String, Object>();
