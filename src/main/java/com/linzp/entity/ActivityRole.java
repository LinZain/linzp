...
public class ActivityRole {
	...
	public String toString() {
		return "ActivityRole [actId=" + actId + ", actTime=" + actTime + ", actStatus=" + actStatus + ", actTitle=" + actTitle
				+ ", actPicUrl=" + actPicUrl + ", actContent=" + actContent + ", actChangetime=" + actChangetime + "]";
	}
